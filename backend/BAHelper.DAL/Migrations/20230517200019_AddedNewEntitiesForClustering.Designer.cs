...
namespace BAHelper.DAL.Migrations
{
    ...
    [Migration("20230517200019_AddedNewEntitiesForClustering")]
    partial class AddedNewEntitiesForClustering
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BAHelper.DAL.Entities.Cluster", b =>
                {
                    ...
                    b.Property<int?>("ClusteredStatisticId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ClusteredStatisticId");

                    b.ToTable("Clusters");
                });

            modelBuilder.Entity("BAHelper.DAL.Entities.ClusteredStatistic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BAHelper.DAL.Entities.Cluster", b =>
                {
                    b.HasOne("BAHelper.DAL.Entities.ClusteredStatistic", null)
                        .WithMany("Clusters")
                        .HasForeignKey("ClusteredStatisticId");
                });
