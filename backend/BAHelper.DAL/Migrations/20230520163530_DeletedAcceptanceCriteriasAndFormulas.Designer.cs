...
namespace BAHelper.DAL.Migrations
{
    ...
    [Migration("20230520163530_DeletedAcceptanceCriteriasAndFormulas")]
    partial class DeletedAcceptanceCriteriasAndFormulas
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BAHelper.DAL.Entities.UserStory", b =>
                {
                    ...
                    b.Property<List<string>>("AcceptanceCriterias")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.Property<List<string>>("Formulas")
                        .IsRequired()
                        .HasColumnType("text[]");
